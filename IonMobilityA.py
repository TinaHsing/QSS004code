...
class mainWindow(QMainWindow):
	...
	def main_UI(self):
		...
		mainLayout.addWidget(self.com.connectBlockWidget(),0,4,1,1)
	...
	def LoadPreset(self):
		...
		#self.com.connectIP.setText(str(self.SettingData[0]))
...
#connect
	def setButtonStatus(self):
		...
		if (self.usb.find_com):
			...
			self.DC_Voltage.SetDC1Btn.setEnabled(False)
			self.DC_Voltage.SetDC2Btn.setEnabled(False)
			self.Fan_Control.SetBtn.setEnabled(False)
