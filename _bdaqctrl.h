...
typedef enum tagPropertyId {
   ...
   CFG_FeatureTrigger1Sources,
   CFG_FeatureTrigger1Actions,
   CFG_FeatureTrigger1DelayCountRange,
   ...
   CFG_TriggerAction,
   CFG_Trigger1Source,
   CFG_Trigger1SourceEdge,
   CFG_Trigger1SourceLevel,
   CFG_Trigger1DelayCount,
   CFG_Trigger1Action,
   ...
   CFG_FeatureTrigger2Sources,
   CFG_FeatureTrigger2Actions,
   CFG_FeatureTrigger2DelayCountRange,
   CFG_FeatureTrigger2SourceVRG,
   CFG_FeatureTrigger2HysteresisIndexMax,
   CFG_FeatureTrigger2HysteresisIndexStep,

   CFG_Trigger2Source,
   CFG_Trigger2SourceEdge,
   CFG_Trigger2SourceLevel,
   CFG_Trigger2DelayCount,
   CFG_Trigger2Action,
   CFG_Trigger2HysteresisIndex,
   CFG_Trigger2FilterType,
   CFG_Trigger2FilterCutoffFreq,

   CFG_FeatureTrigger3Sources,
   CFG_FeatureTrigger3Actions,
   CFG_FeatureTrigger3DelayCountRange,
   CFG_FeatureTrigger3SourceVRG,
   CFG_FeatureTrigger3HysteresisIndexMax,
   CFG_FeatureTrigger3HysteresisIndexStep,

   CFG_Trigger3Source,
   CFG_Trigger3SourceEdge,
   CFG_Trigger3SourceLevel,
   CFG_Trigger3DelayCount,
   CFG_Trigger3Action,
